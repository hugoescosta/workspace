 ...
 * @author Ronaldo
 */
public class ViewTable3 extends javax.swing.JFrame {

    /**
     * Creates new form ViewTable3
     */
    public ViewTable3() {
        initComponents();
...
//        System.out.println("Linha selecionada" + jTProdutos.getSelectedRow()); 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewTable3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewTable3().setVisible(true);
            }
        });
    }
